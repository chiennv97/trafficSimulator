...
public class OtoYTurnLeft {
    ...
    int stopline;
    int countCar=0;
    public OtoYTurnLeft(int positionY, int getX, int sizeCar, java.awt.Color color, int turnX, int size, boolean typeX, int distance, int stopline){
